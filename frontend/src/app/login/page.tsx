      ...
      if (typeof window !== 'undefined' && (window as any).google) {
        try {
          ...
          (window as any).google.accounts.id.renderButton(
            container || document.getElementById('google-signin-btn'),
          ...
          <div className="space-y-4 rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="mt-1 block w-full rounded-md border border-slate-300 px-3 py-2 placeholder-slate-400 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white sm:text-sm"
